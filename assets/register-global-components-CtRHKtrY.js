...
`);
  ...
  function tn() {
    Sn(), e.value.highlightjs && __vitePreload(() => import("./index-CDIRYBz_.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0).then((a) => {
    ...
    }), e.value.prismjs && __vitePreload(() => import("./prism-rcBZLCmt.js").then((n) => n.p), true ? [] : void 0).then((a) => {
