...
//.body--light .my-card .my-markdown h1:nth-child(1)
    .archive-title::after, .article-title::after {
        display: block;
        content: "";
        background: transparent url(https://makeyourschool.de/wp-content/themes/mys/assets/css/../../assets/img/title-dots.svg) no-repeat;
        width: 4.4rem;
        height: .625rem;
        margin-top: 1.68rem;
    }
