import { u as useFieldEmits, a as useFormProps, b as useNonInputFieldProps, c as useFieldState, d as useFormInputNameAttr, e as useFileFormDomProps, f as fieldValueIsFilled, g as useField, h as useFieldProps, i as useKeyComposition, j as useFormInject, Q as QInput } from "./QInput-CEayznOf.js";
import { I as createComponent, c as computed, h, O as hSlot, a as getCurrentInstance, a2 as useSizeProps, a3 as useSize, a4 as hDir, Y as QIcon, a5 as hMergeSlotSafely, a6 as Ripple, N as stopAndPrevent, r as ref, a7 as stop, a8 as client, a9 as injectProp, aa as prevent, ab as hUniqueSlot, w as watch, ac as nextTick, ad as debounce, q as onBeforeMount, ae as onDeactivated, af as onActivated, J as onBeforeUnmount, ag as noop, ah as listenOpts, o as onMounted, ai as hMergeSlot, aj as isKeyCode, ak as position, M as Transition, al as childHasFocus, am as isDeepEqual, an as shouldIgnoreKey, ao as onBeforeUpdate, ap as onUpdated, aq as toRaw, ar as vmHasRouter, as as History, at as isNumber, au as isDate, av as isObject, aw as injectMultipleProps, ax as QBtn, Z as watchEffect, H as createBlock, v as openBlock, P as withCtx, l as createBaseVNode, j as createVNode } from "./index-CH6HKi7w.js";
import { u as useDarkProps, a as useDark } from "./use-dark-SF6xadml.js";
import { h as humanStorageSize, u as useHistory, a as usePreventScroll, n as normalizeToInterval } from "./use-prevent-scroll-Ctk_x_Nb.js";
import { Q as QSeparator } from "./QSeparator-DNdEXyJF.js";
import { c as QList, b as QItemSection, a as QItemLabel, Q as QItem } from "./QList-0IbFaDey.js";
import { s as scrollTargetProp, g as getScrollTarget, u as useModelToggleEmits, a as useModelToggleProps, b as useModelToggle } from "./scroll-HaGXmoQC.js";
import { v as validateOffset, a as validatePosition, u as useTransitionProps, i as useAnchorProps, c as useTick, d as useTransition, e as useScrollTarget, f as useAnchor, g as usePortal, p as parsePosition, h as addClickOutside, r as removeClickOutside, j as closePortalMenus, s as setPosition } from "./position-engine-K1k5B0Td.js";
import { a as useTimeout, u as useQuasar } from "./use-quasar-CPCGCj_K.js";
import { a as addFocusFn } from "./focus-manager-B-vefqia.js";
import { Q as QPage } from "./QPage--lN_OrsY.js";
import "./use-id-lVp2KA0W.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const columns = [
      ...
      {
        name: "manufactureURL",
        label: "manufactureURL",
        field: (row) => row.manufactureURL,
        style: "background-color: rgb(20,0,20)"
      },
      {
        name: "productURL",
        label: "productURL",
        field: (row) => row.productURL
      },
      {
        name: "coverImage",
        label: "coverImage",
                ...
                createVNode(QTr, { props }, {
                  default: withCtx(() => [
                    createVNode(QTd, {
                      ...
                      default: withCtx(() => [
                        createVNode(QInput, {
                          modelValue: props.row.repoName,
                          "onUpdate:modelValue": ($event) => props.row.repoName = $event,
                          dense: "",
                          borderless: ""
                    ...
                    createVNode(QTd, {
                      ...
                      default: withCtx(() => [
                        createVNode(QInput, {
                          modelValue: props.row.manufactureURL,
                          "onUpdate:modelValue": ($event) => props.row.manufactureURL = $event,
                          dense: "",
                          borderless: ""
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ]),
                    ...
                    createVNode(QTd, {
                      ...
                      default: withCtx(() => [
                        createVNode(QInput, {
                          modelValue: props.row.productURL,
                          "onUpdate:modelValue": ($event) => props.row.productURL = $event,
                          dense: "",
                          borderless: ""
                        }, null, 8, ["modelValue", "onUpdate:modelValue"])
                      ]),
