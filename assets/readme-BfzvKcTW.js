...
import { L as resolveComponent, N as openBlock, U as withCtx, g as createVNode, h as createTextVNode, m as createStaticVNode, p as createElementBlock, u as createBaseVNode } from "./vue.esm-bundler-DkjeOeAQ.js";
//#region public/mks/parts/mks-generic-Endschalter/readme.md
...
var title = "Endschalter/Anschlag";
var date = "2018-10-01T13:43:35.000Z";
var tags = [
	"sensor",
	"taster",
	"schalter",
...
var coverImage = "./mys_mk_25.png";
var material_type = "sensor";
var manufacture = "generic";
var repo_name = "generic-Endschalter";
var product_url = "https://www.reichelt.de/de/de/shop/kategorie/schnappschalter_endschalter-7599";
var clone_url = "https://github.com/Make-Your-School/mks-generic-Endschalter.git";
var repo_part = "Endschalter";
var embedded_example_file = "examples/Endschalter_minimal/Endschalter_minimal.ino";
var status = "active";
var difficulty = "advanced";
var excerpt = "<h1 id=\"endschalter%2Fanschlag\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#endschalter%2Fanschlag\">Endschalter/Anschlag</a></h1>\n<p><img src=\"/mks/parts/mks-generic-Endschalter/mys_mk_25.png\" alt=\"Endschalter/Anschlag\"></p>\n<h2 id=\"beschreibung\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#beschreibung\">Beschreibung</a></h2>\n<p>Der Endschalter funktioniert wie ein normaler Schalter und kann als Eingabe für einen Mikrocontroller verwendet werden.\nDer Schalter besitzt einen elastischen Schaltarm, der einen elektrischen Kontakt zwischen den Anschlusspins herstellt, wenn der Arm gedrückt wird.</p>\n";
var _sfc_main = {
	__name: "readme",
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				createBaseVNode("p", null, [
					...
					createVNode(_component_MDAbbr, null, {
						default: withCtx(() => _cache[6] || (_cache[6] = [createTextVNode("Pin")])),
					...
					createVNode(_component_MDAbbr, null, {
						default: withCtx(() => _cache[8] || (_cache[8] = [createTextVNode("Pin")])),
...
//#endregion
export { readme_exports as n, _sfc_main as t };
