...
import { L as resolveComponent, N as openBlock, U as withCtx, d as createBlock, g as createVNode, h as createTextVNode, it as unref, m as createStaticVNode, p as createElementBlock, u as createBaseVNode } from "./vue.esm-bundler-DdwSdRj_.js";
import { t as QPage_default } from "./QPage-BDr_fs7R.js";
//#region public/demo/readme.md
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$1, [
				_cache[16] || (_cache[16] = createStaticVNode("<h1 id=\"demo\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#demo\">Demo</a></h1><p>Hier ist ein Text / Test um alle verfügbaren Formatierungsoptionen zu testen. Dies dient auch als Reference 🎉</p><p>den sorce-code dieses <em>readme.md</em> datei findest du unter</p><p><a href=\"https://github.com/Make-Your-School/mks-welcome/blob/main/public/demo/readme.md?plain=1\">https://github.com/Make-Your-School/mks-welcome/blob/main/public/demo/readme.md?plain=1</a></p><p>ein link mit <em>titel</em> geht so: <a href=\"https://makeyourschool.de/material/\">mks</a></p><p>nun der - momentan ungenutzte - more_details link break.</p><p>dieser Text kommt dann nach dem more_details break…</p><h2 id=\"abbr\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#abbr\">Abbr</a></h2>", 8)),
				createBaseVNode("p", null, [
					...
					createVNode(_component_MDAbbr, null, {
						default: withCtx(() => _cache[0] || (_cache[0] = [createTextVNode("HTML")])),
						abbrDescription: withCtx(() => _cache[1] || (_cache[1] = [createBaseVNode("p", null, "Hyper Text Markup Language", -1)])),
						_: 1
					}),
					_cache[11] || (_cache[11] = createTextVNode(". Oder das eher unbekannte ")),
					createVNode(_component_MDAbbr, null, {
						default: withCtx(() => _cache[2] || (_cache[2] = [createTextVNode("W3C")])),
						abbrDescription: withCtx(() => _cache[3] || (_cache[3] = [createBaseVNode("p", null, "World Wide Web Consortium", -1)])),
						_: 1
					}),
					...
					createVNode(_component_MDAbbr, null, {
						default: withCtx(() => _cache[6] || (_cache[6] = [createTextVNode("I2C")])),
				...
				_cache[17] || (_cache[17] = createStaticVNode("<h2 id=\"info-boxes%E2%80%A6\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#info-boxes%E2%80%A6\">Info Boxes…</a></h2><p>Diese Box-Typen werden alle unterstützt:</p><div class=\"markdown-alert markdown-alert-tip\"><p class=\"markdown-alert-title\">Tip</p><p>This is a tip</p></div><div class=\"markdown-alert markdown-alert-notiz\"><p class=\"markdown-alert-title\">Notiz</p><p>Eine Notiz</p></div><div class=\"markdown-alert markdown-alert-wichtig\"><p class=\"markdown-alert-title\">Wichtig</p><p>Wichtige Informationen für diese Bauteil!</p></div><div class=\"markdown-alert markdown-alert-achtung\"><p class=\"markdown-alert-title\">Achtung</p><p>Bitte Vorsichtig sein!</p></div><div class=\"markdown-alert markdown-alert-warnung\"><p class=\"markdown-alert-title\">Warnung</p><p>Achtung Achtung!!! ganz wichtig…</p></div><h2 id=\"code\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#code\">code</a></h2><p>code kannst du wie folgt einfügen:</p>", 9)),
				...
				createVNode(_component_MDExamples, {
					...
					contentJSON: withCtx(() => _cache[15] || (_cache[15] = [createTextVNode("{ \"cp_welcome\": { \"example_path\": \"public/demo/examples/cp_welcome\", \"example_url\": \"https://github.com/Make-Your-School/demo/tree/main/examples/cp_welcome\", \"example_path_app\": \"/mks-welcome/demo/examples/cp_welcome/\", \"files\": { \"main.py\": { \"file_url\": \"https://github.com/Make-Your-School/demo/tree/main/examples/cp_welcome/main.py\", \"file_path\": \"public/demo/examples/cp_welcome/main.py\", \"file_path_web\": \"/mks-welcome/demo/examples/cp_welcome/main.py\", \"example_path_app\": \"/mks-welcome/demo/examples/cp_welcome/\", \"file_name\": \"main.py\", \"name\": \"main.\", \"file_ext\": \"py\", \"content\": \"\\\"\\\"\\\"\\nCircuitPython hello world.\\n\\\"\\\"\\\"\\n\\nimport time\\nimport board\\nimport neopixel\\n\\npixels = neopixel.NeoPixel(board.GP18, 2)\\npixels.fill(0)\\n\\nprint(\\\"Hello World :-)\\\")\\n\\nwhile True:\\n    pixels.fill(0x0000ff)\\n    time.sleep(0.5)\\n    pixels.fill(0x00ff00)\\n    time.sleep(0.5)\\n    pixels.fill(0xff00ff)\\n    time.sleep(0.5)\\n    pixels.fill(0x000100)\\n    time.sleep(1.0)\\n\" } } }, \"demo1\": { \"example_path\": \"public/demo/examples/demo1\", \"example_url\": \"https://github.com/Make-Your-School/demo/tree/main/examples/demo1\", \"example_path_app\": \"/mks-welcome/demo/examples/demo1/\", \"files\": { \"demo1.ino\": { \"file_url\": \"https://github.com/Make-Your-School/demo/tree/main/examples/demo1/demo1.ino\", \"file_path\": \"public/demo/examples/demo1/demo1.ino\", \"file_path_web\": \"/mks-welcome/demo/examples/demo1/demo1.ino\", \"example_path_app\": \"/mks-welcome/demo/examples/demo1/\", \"file_name\": \"demo1.ino\", \"name\": \"demo1.\", \"file_ext\": \"ino\", \"content\": \"// *Hallo Welt* in Hardware.\\n// Lasse die eingebaute LED Blinken.\\n\\nconst int led_pin = LED_BUILTIN;\\n\\nvoid setup() { pinMode(led_pin, OUTPUT); }\\n\\nvoid loop() {\\n  digitalWrite(led_pin, HIGH);\\n  delay(500);\\n  digitalWrite(led_pin, LOW);\\n  delay(2 * 1000);\\n}\\n\" } } }, \"pingpong\": { \"example_path\": \"public/demo/examples/pingpong\", \"example_url\": \"https://github.com/Make-Your-School/demo/tree/main/examples/pingpong\", \"example_path_app\": \"/mks-welcome/demo/examples/pingpong/\", \"files\": { \"pingpong.ino\": { \"file_url\": \"https://github.com/Make-Your-School/demo/tree/main/examples/pingpong/pingpong.ino\", \"file_path\": \"public/demo/examples/pingpong/pingpong.ino\", \"file_path_web\": \"/mks-welcome/demo/examples/pingpong/pingpong.ino\", \"example_path_app\": \"/mks-welcome/demo/examples/pingpong/\", \"file_name\": \"pingpong.ino\", \"name\": \"pingpong.\", \"file_ext\": \"ino\", \"content\": \"int countdown = 15;\\n\\nvoid setup() { Serial.begin(115200);\\n  Serial.println(\\\"pingpong.ino - los gehts!\\\");\\n}\\n\\nvoid loop() {\\n  Serial.println(countdown);\\n  countdown = countdown - 1;\\n  if (countdown == 0) {\\n    Serial.println(\\\"jetzt piepts...\\\");\\n    delay(1000);\\n    Serial.println(\\\"hör auf mit dem gepiepe...\\\");\\n  }\\n  delay(1000);\\n}\\n\" } } } }")])),
					_: 1
				}),
				_cache[27] || (_cache[27] = createStaticVNode("<h2 id=\"bilder\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#bilder\">Bilder</a></h2><p>Bilder werden mit</p><p><img src=\"/mks-welcome/demo/test_image.png\" alt=\"test\"></p><p>eingebunden.</p><h2 id=\"%C3%BCberschriften\" tabindex=\"-1\"><a class=\"header-anchor\" href=\"#%C3%BCberschriften\">Überschriften</a></h2>", 5)),
				createVNode(_component_MDCode, {
...
//#endregion
//#region src/pages/dev/MDDemo.vue
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(QPage_default, {
				...
				default: withCtx(() => [createBaseVNode("section", _hoisted_1, [_cache[0] || (_cache[0] = createTextVNode(" Markdown Test Page ")), createVNode(unref(MDContent))])]),
				_: 1
			});
		};
	}
