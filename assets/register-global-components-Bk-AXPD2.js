...
`);
  ...
  function tn() {
    Sn(), e.value.highlightjs && __vitePreload(() => import("./index-ZXU6qJ2n.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0).then((a) => {
    ...
    }), e.value.prismjs && __vitePreload(() => import("./prism-CzgzNftP.js").then((n) => n.p), true ? [] : void 0).then((a) => {
