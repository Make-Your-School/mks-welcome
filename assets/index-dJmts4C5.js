...
import { c as createReactivePlugin, o as createComponent, r as hMergeSlotSafely } from "./render-BO3Z2Al6.js";
import { a as listenOpts, o as noop } from "./event-JAmtdkur.js";
import { t as debounce } from "./debounce-xC9d6Tps.js";
import { i as useSizeProps, n as useSize, o as onKeyDownComposition, t as QIcon_default } from "./QIcon-DHY_8p3W.js";
...
var router_default = route(function() {
	return createRouter({
		...
		routes,
		history: (process$1.env.SERVER ? createMemoryHistory : process$1.env.VUE_ROUTER_MODE === "history" ? createWebHistory : createWebHashHistory)(process$1.env.VUE_ROUTER_BASE)
	});
});
//#endregion
