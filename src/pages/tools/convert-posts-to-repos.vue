                ...
                <template v-slot:body="props">
                    <q-tr :props="props">
                        <q-td key="repoName" :props="props">
                            <q-input v-model="props.row.repoName" dense borderless />
                        </q-td>
                        ...
                        <q-td key="manufactureURL" :props="props">
                            <q-input v-model="props.row.manufactureURL" dense borderless />
                        </q-td>
                        <q-td key="productURL" :props="props">
                            <q-input v-model="props.row.productURL" dense borderless />
                        </q-td>
