...
const PartOverview = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bcbe768c"]]);
...
const PartDetails = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d8ba2ee2"]]);
...
const getPartsContent = () => {
  return /* @__PURE__ */ Object.assign({
    "../../public/mks/parts/mks-Endschalter/readme.md": __vite_glob_1_0,
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const check_searchTextInReadme = (readme2, item_name) => {
      var _a, _b;
      return (item_name == null ? void 0 : item_name.toLowerCase().includes(searchText.value.toLowerCase())) || readme2.content.toLowerCase().includes(searchText.value.toLowerCase()) || ((_b = (_a = readme2.data) == null ? void 0 : _a.tags) == null ? void 0 : _b.join(", ").toLowerCase().includes(searchText.value.toLowerCase()));
    };
...
const MKS_Parts = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-51811409"]]);
export {
