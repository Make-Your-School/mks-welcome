const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-b02iC7Ma.js","assets/index-B9s8Pg5P.js","assets/index-B1cEtIL_.css","assets/use-quasar-v7fXgcWv.js","assets/position-engine-BRNQ7mz8.js","assets/focus-manager-B-vefqia.js","assets/scroll-Dku3Hklk.js","assets/_plugin-vue_export-helper-1tPrXgE0.js"])))=>i.map(i=>d[i]);
import { l as createBaseVNode, d as defineComponent, m as mergeDefaults, u as useSlots, b as inject, r as ref, t as toRefs, c as computed, n as unref, p as createElementBlock, w as watch, q as onBeforeMount, o as onMounted, v as openBlock, x as createCommentVNode, y as normalizeStyle, z as renderSlot, B as normalizeProps, C as mergeProps, F as Fragment, D as createTextVNode, E as toDisplayString, G as normalizeClass, H as createBlock, _ as __vitePreload, j as createVNode, I as createComponent, a as getCurrentInstance, J as onBeforeUnmount, K as cleanEvt, L as addEvt, h, M as Transition, N as stopAndPrevent, O as hSlot, P as withCtx } from "./index-B9s8Pg5P.js";
import { u as useQuasar, a as useTimeout, c as clearSelection } from "./use-quasar-v7fXgcWv.js";
import { u as useTransitionProps, v as validateOffset, a as validatePosition, b as useAnchorStaticProps, p as parsePosition, c as useTick, d as useTransition, e as useScrollTarget, f as useAnchor, g as usePortal, h as addClickOutside, r as removeClickOutside, s as setPosition } from "./position-engine-BRNQ7mz8.js";
import { u as useModelToggleEmits, s as scrollTargetProp, a as useModelToggleProps, b as useModelToggle, g as getScrollTarget } from "./scroll-Dku3Hklk.js";
...
`);
  ...
  function tn() {
    Sn(), e.value.highlightjs && __vitePreload(() => import("./index-b02iC7Ma.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6,7]) : void 0).then((a) => {
    ...
    }), e.value.prismjs && __vitePreload(() => import("./prism-DRJPVlZ1.js").then((n) => n.p), true ? [] : void 0).then((a) => {
