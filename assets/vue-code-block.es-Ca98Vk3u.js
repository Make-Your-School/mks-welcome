...
`);
  ...
  function tn() {
    Sn(), e.value.highlightjs && __vitePreload(() => import("./index-DDvNrWhZ.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0).then((a) => {
    ...
    }), e.value.prismjs && __vitePreload(() => import("./prism-B0C402Qe.js").then((n) => n.p), true ? __vite__mapDeps([4,2]) : void 0).then((a) => {
