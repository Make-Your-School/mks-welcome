...
`);
  ...
  function tn() {
    ...
    }), e2.value.prismjs && __vitePreload(() => import("./prism.02919061.js").then(function(n2) {
      return n2.p;
    }), true ? [] : void 0).then((a2) => {
