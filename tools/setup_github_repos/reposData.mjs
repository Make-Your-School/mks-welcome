export const data = [
    // {
    //     name: 'PingPong',
    //     description: 'immer hin und her..',
    //     data: {
    //         title: 'Ping-Pong Peng!',
    //         markdown: '#Hello!',
    //     },
    // },
    // {
    ...
    //     },
    {
        repoName: 'mks-Arduino-UNO_R3',
        manufacture: 'Arduino',
        manufactureURL: 'https://arduino.cc/',
        productURL: 'https://store.arduino.cc/products/arduino-uno-rev3',
        description: '',
        title: 'Arduino UNO',
        content: `Der Arduino UNO ist ein Mikrocontroller, der es ermöglicht, prinzipiell jegliche Art von technischen Vorgängen automatisiert miteinander zu koordinieren. Dafür besitzt der Mikrocontroller viele Ein- und Ausgänge (Inputs und Outputs). Diese sind elektrische Anschlüsse, an die verschiedene technische Komponenten, wie Sensoren oder auch Aktoren (Motoren, Leuchten etc.), angeschlossen werden können. Wird der Mikrocontroller entsprechend programmiert, können diese Komponenten logisch miteinander verknüpft werden. Dadurch können die Komponenten gemeinsam eine technische Aufgabe erfüllen.
...
<iframe width="1107" height="623" src="https://www.youtube.com/embed/GQw20v8Qls0" title="Der Arduino UNO: Eine Einführung" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

<iframe width="1107" height="623" src="https://www.youtube.com/embed/EEa-0fhb2WA" title="Die Programmierlogik der Arduino IDE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
