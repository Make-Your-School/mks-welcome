...
var FunctionOverview = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-093ede36"]]);
...
const mksGetContent = () => {
  ...
  const path_base = "mks/";
  mksContent2.welcome.readme = preProcessingMD(temp["./readme.md"]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const check_searchTextInReadme = (readme, item_name) => {
      var _a, _b;
      return (item_name == null ? void 0 : item_name.toLowerCase().includes(searchText.value.toLowerCase())) || readme.content.toLowerCase().includes(searchText.value.toLowerCase()) || ((_b = (_a = readme.data) == null ? void 0 : _a.tags) == null ? void 0 : _b.toLowerCase().includes(searchText.value.toLowerCase()));
    };
    ...
    const mks_funktionen_filtered = computed(() => {
      ...
      for (const [fn_name, fn_item] of Object.entries(mks_funktionen.value)) {
        ...
        if (check_searchTextInReadme(fn_item.readme, fn_name) || Object.keys(bauteile_includes).length > 0) {
      ...
      return openBlock(), createBlock(QPage, { class: "my-page" }, {
        default: withCtx(() => [
          ...
          createBaseVNode("ul", _hoisted_1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(mks_funktionen_filtered.value, (fn_item, fn_name) => {
...
var IndexPage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6f61c18c"]]);
